...
import allPossibleMovesDict from './data/all_moves.json' with { type: "json" };
import allPossibleMovesReversedDict from './data/all_moves_reversed.json' with { type: "json" };
import allPossibleMovesDictMaia from "./data/all_moves_maia.json" with { type: "json" };
import allPossibleMovesReversedMaiaDict from "./data/all_moves_reversed_maia.json" with { type: "json" };
